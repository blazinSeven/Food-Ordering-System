...
public class SortByRating {
    ...
    public SortByRating(String city, String province)
    {
    ...
    {
        SortByRating sortByRating = new SortByRating("Saskatoon","SK");
        //System.out.println(sortByRating.getSortByRatingWithoutLogin());
        for (int i = 0; i< sortByRating.sortInfos.size(); i++){
            System.out.println(sortByRating.sortInfos.get(i).getRest_name());
        }
    }
}
