package Sort;
/**
 * Create by Yinsheng Dong Nov 28
 */
...
public class SortByPrice {
    ...
    public ArrayList<SortInfo> getSortByPriceWithoutLogin() {
        return sortInfos;
    }

    private void sortbyPriceWithoutLogin(String city, String province)
    {
    ...
    public SortByPrice(String city, String province)
    {
        sortbyPriceWithoutLogin(city,province);
    }

    public static void main(String arg[])
    {
        SortByPrice sortByPrice = new SortByPrice("Saskatoon","SK");
        //System.out.println(sortByPrice.getSortByPriceWithoutLogin());
        for (int i = 0; i< sortByPrice.sortInfos.size(); i++){
            System.out.println(sortByPrice.sortInfos.get(i).getRest_id());
        }
