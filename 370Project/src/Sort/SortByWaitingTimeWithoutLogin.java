...
public class SortByWaitingTimeWithoutLogin {
    ...
    public SortByWaitingTimeWithoutLogin(String city, String province)
    {
    ...
    {
        SortByWaitingTimeWithoutLogin sortByWaitingTimeWithoutLogin = new SortByWaitingTimeWithoutLogin("Saskatoon","SK");
        System.out.println(sortByWaitingTimeWithoutLogin.getSortByWaitingTimeWithoutLogin());
    }
}
