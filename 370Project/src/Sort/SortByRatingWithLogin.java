...
import google.*;
public class SortByRatingWithLogin
{
    ...
    public ArrayList<SortInfo> getSortRate() {
        return sortInfos;
    }

    public void sortByRate(int customer_id)
    {
    ...
    public SortByRatingWithLogin(int customer_id)
    {
        sortByRate(customer_id);
    }

    public static void main(String arg[])
    {
        SortByRatingWithLogin sortByRating = new SortByRatingWithLogin(19);
        System.out.println(sortByRating.getSortRate());
