...
public class SortByPriceWithoutLogin {
    ...
    public SortByPriceWithoutLogin(String city, String province)
    {
    ...
    {
        SortByPriceWithoutLogin sortByPriceWithoutLogin = new SortByPriceWithoutLogin("Saskatoon","SK");
        System.out.println(sortByPriceWithoutLogin.getSortByPriceWithoutLogin());
    }
}
